(function () {
  ...
  var I18N = {
    he: {
      ...
      'team.title': 'האנשים מאחורי הקוד',
      't1.name': 'אושר וטרי',
      't1.role': 'מנכ״ל',
      't2.name': 'ניר מיכלוביץ׳',
      't2.role': 'מנהל לקוחות ישראל',
      't3.name': 'יואב בר אשר',
      't3.role': 'מנהל לקוחות ארה״ב',
    ...
    en: {
      ...
      'team.title': 'The people behind the code',
      't1.name': 'Osher Vatari',
      't1.role': 'CEO',
      't2.name': 'Nir Michalovitz',
      't2.role': 'Client Manager, Israel',
      't3.name': 'Yoav Bar Asher',
      't3.role': 'Client Manager, USA',
