(function () {
  ...
  var I18N = {
    he: {
      ...
      'hero.sub': 'בונים אתרים בתשומת לב, מהרעיון ועד העלייה לאוויר.<br>לאורך השנים זכינו ללוות חברות וגופים מובילים בישראל, ביניהם שיכון ובינוי, אלקטרה ודמרי. כל אתר נבנה ביחד אתכם, בהקשבה ובדיוק — בישראל ובארצות הברית.',
    ...
    en: {
      ...
      'hero.sub': 'Websites built with care, from first idea to launch.<br>Over the years we’ve had the privilege of working with leading companies in Israel — among them Shikun & Binui, Electra, and Dimri. Every site is built together with you, with attention and precision — in Israel and the US.',
