(function () {
  ...
  var I18N = {
    he: {
      ...
      'tt.p3': 'כל שינוי במבנה האתר מנוהל תחת בקרת גרסאות ונפרס באופן אוטומטי. התוכן וקבצי המדיה מאוחסנים בענן עם יתירות מלאה. טפסים ופניות מהאתר מעובדים על גבי תשתית Serverless, תוך שימוש בסינון בוטים סמוי ומבוסס-אתגרים, יחד עם ניתוח AI מוקדם למניעת ספאם, עוד לפני שמידע כלשהו בכלל מתקבל במערכת. אפס תחזוקה, גיבוי מובנה, והגנה מודרנית בכל שכבה.',
      'p1.title': 'אפיון',
