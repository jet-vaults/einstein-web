(function () {
  ...
  var I18N = {
    he: {
      ...
      'team.title': 'צוות קטן, <span class="hl">תשומת לב גדולה</span>',
      'team.sub': 'אלה אנחנו. אין קומת מנהלים — כולנו עובדים על האתר שלכם.',
      't1.name': 'אושר ותארי',
      't1.role': 'ליווי פרויקטים',
      't2.name': 'ניר מיכלוביץ׳',
      't2.role': 'פיתוח וניהול',
      ...
      'r3.text': 'אושר בנה עבורנו את פורטל הדיירים לפרויקט, והתוצאה מדהימה. האתר משלב עיצוב נקי ומקצועי עם ארכיטקטורת מידע ברורה מאוד - סטטוס פרויקט, תהליך בחירת דירה, קטלוג דגמים, מסמכים להורדה ושאלות נפוצות, הכל מסודר בצורה שהופכת מידע מורכב לנגיש וידידותי לדיירים. מה שבלט לנו לאורך כל התהליך זה השילוב הנדיר בין מקצועיות בביצוע, זמינות אמיתית לאורך העבודה, עמידה בלוחות זמנים, והכי חשוב הבנה מדויקת של מה שרצינו, גם כשלא תמיד ידענו לנסח את זה בעצמנו. אושר הצליח לתרגם את הצרכים שלנו לפתרון דיגיטלי שמכבד את הפרויקט ומשרת את הדיירים בפועל. ממליצים בחום לכל מי שמחפש איש מקצוע שמבין גם עיצוב, גם טכנולוגיה וגם את הצד האנושי של הפרויקט.',
      'r3.who': 'קבוצת גלנור',
    ...
    en: {
      ...
      'team.title': 'A small team, <span class="hl">big attention to detail</span>',
      'team.sub': 'This is us. No executive floor — we all work on your site.',
      't1.name': 'Osher Vatari',
      't1.role': 'Project guidance',
      't2.name': 'Nir Michalovitz',
      't2.role': 'Development & management',
      ...
      'r3.text': 'Osher built the resident portal for our project, and the result is stunning. The site combines clean, professional design with very clear information architecture – project status, the apartment selection process, a model catalog, downloadable documents and FAQs, all organized in a way that turns complex information into something accessible and friendly for residents. What stood out throughout the process was the rare combination of professional execution, genuine availability, meeting deadlines, and most importantly – a precise understanding of what we wanted, even when we could not always articulate it ourselves. Osher translated our needs into a digital solution that honors the project and truly serves the residents. Warmly recommended to anyone looking for a professional who understands design, technology, and the human side of a project.',
      'r3.who': 'Galnur Group',
