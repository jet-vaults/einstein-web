(function () {
  ...
  var I18N = {
    he: {
      ...
      'hero.title': 'מפתח האתרים שמאחורי<br><span class="hl">מותגי הנדל״ן הגדולים בישראל.</span>',
      'hero.sub': 'שיכון ובינוי. אלקטרה. דמרי. כשחברות הנדל״ן המובילות בישראל צריכות אתר שמוכר, הן פונות לאיינשטיין אתרים. עכשיו בונים גם ללקוחות בישראל ובארצות הברית.',
    ...
    en: {
      ...
      'hero.title': 'The Web Developer Behind<br><span class="hl">Israel’s Biggest Real Estate Brands.</span>',
      'hero.sub': 'Shikun & Binui. Electra. Dimri. When Israel’s leading developers need a website that sells, they call Einstein Web. Now building for clients in Israel and the United States.',
