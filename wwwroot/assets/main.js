(function () {
  ...
  var I18N = {
    he: {
      ...
      'tech.kicker': 'הטכנולוגיות שלנו',
      'tech.title': 'הכלים שאיתם אנחנו בונים',
      'tw.title': 'האתרים שלנו שונים',
      'tw.p1': '<strong>מהירות, אבטחה, פשטות.</strong> האתרים שלנו <strong>נטענים כהרף עין</strong> בכל מקום בעולם, שומרים על <strong>זמינות סביב השעון</strong>, <strong>חוסמים בוטים</strong>, ומתאימים את עצמם לכל היקף תנועה ללא מאמץ - מקומץ גולשים ועד לזרם אדיר של מבקרים, <strong>ללא תוספת עלות</strong>. בניגוד לתוכנות המסורבלות והפגיעות שעומדות בבסיסם של אתרים מסורתיים רבים, האתרים שלנו רזים בהרבה ו<strong>חסינים לווקטורי התקיפה הקלאסיים</strong>.',
      'tw.p2': 'אותה תשתית בדיוק גם עוזרת ללקוחות למצוא אתכם: האתרים נטענים מהר, <strong>זוכים לדירוג גבוה</strong>, ומתוכננים מראש <strong>לקריאה חלקה על ידי AI</strong>. כך העסק שלכם צף ובולט גם בתוצאות החיפוש וגם בתוך כלי בינה מלאכותית. כל מידע שהגולשים שלכם שולחים זוכה <strong>להגנה הרמטית</strong> - בוטים נחסמים באופן אוטומטי, ומערכת AI ייעודית מסננת הודעות ספאם ותוכן פוגעני, כך ש<strong>רק פניות אמיתיות מגיעות אליכם</strong>. אתם יכולים להתמקד בעסק, והאתר שלכם דואג לעצמו.',
      'tw.p3': 'אם אתר וורדפרס או פלטפורמות דומות הן <strong>משאית ישנה</strong>: חלודה, כבדה, איטית ולא בטוחה על הכביש, אתר שלנו הוא <strong>מכונית ספורט חשמלית</strong>: מהירה, יעילה, ומהונדסת עם מנגנוני הגנה המוטמעים בכל רכיב.',
      'tt.title': 'הטכנולוגיה שלנו',
      'tt.p1': '<strong>ארכיטקטורת Jamstack:</strong> האתר שלכם נבנה מראש כקבצים סטטיים ומוגש דרך <strong>רשת קצה גלובלית</strong>, מה שמבטיח <strong>טעינה במהירות מקסימלית</strong>, צמצום ניכר של משטח התקיפה, ו<strong>הגנה איתנה מפני מתקפות DDoS</strong> ותעבורה זדונית.',
      'tt.p2': 'הגשת תוכן סטטי מספקת <strong>גמישות אלסטית</strong> אל מול עומסים בעלות שולית שואפת לאפס. היא מעניקה לאתר <strong>בסיס חזק ל-SEO ולמדדי ה-Core Web Vitals</strong>, יחד עם Markup סמנטי ונקי שסורקים של מנועי חיפוש ומודלים של בינה מלאכותית קוראים בקלות רבה.',
      'tt.p3': 'כל שינוי במבנה האתר מנוהל תחת <strong>בקרת גרסאות</strong> ונפרס באופן אוטומטי. התוכן וקבצי המדיה מאוחסנים בענן עם <strong>יתירות מלאה</strong>. טפסים ופניות מהאתר מעובדים על גבי <strong>תשתית Serverless</strong>, תוך שימוש בסינון בוטים סמוי ומבוסס-אתגרים, יחד עם <strong>ניתוח AI מוקדם למניעת ספאם</strong>, עוד לפני שמידע כלשהו בכלל מתקבל במערכת. <strong>אפס תחזוקה, גיבוי מובנה, והגנה מודרנית בכל שכבה.</strong>',
      'p1.title': 'אפיון',
    ...
    en: {
      ...
      'tech.kicker': 'Our stack',
      'tech.title': 'The technologies we build with',
      'tw.title': 'Why our websites are different',
      'tw.p1': '<strong>Speed, security, simplicity.</strong> Our websites <strong>load in the blink of an eye</strong> anywhere in the world, stay online <strong>around the clock</strong>, <strong>block bots</strong>, and effortlessly adapt to any volume of traffic - from a handful of visitors to a massive surge - <strong>without added costs</strong>. Unlike the bulky, vulnerable software that powers many traditional sites, ours are vastly leaner and <strong>immune to classic attack vectors</strong>.',
      'tw.p2': 'That exact same infrastructure also helps customers find you: our sites load fast, <strong>achieve high rankings</strong>, and are <strong>pre-engineered for seamless reading by AI</strong>. This ensures your business surfaces and stands out in both search engine results and AI tools. Any information your visitors submit receives <strong>airtight protection</strong> - bots are blocked automatically, and a dedicated AI system screens messages for spam and abusive content, ensuring <strong>only genuine inquiries reach you</strong>. You can focus on your business, and your website takes care of itself.',
      'tw.p3': 'If WordPress or similar platforms are an <strong>old truck</strong> - rusty, heavy, slow, and unsafe on the road - our website is an <strong>electric sports car</strong>: fast, efficient, and engineered with protective mechanisms embedded into every single component.',
      'tt.title': 'Our tech',
      'tt.p1': '<strong>Jamstack architecture:</strong> your site is pre-built as static files and served through a <strong>global edge network</strong>, guaranteeing <strong>maximum load speeds</strong>, a significantly reduced attack surface, and <strong>robust protection against DDoS attacks</strong> and malicious traffic.',
      'tt.p2': 'Static content delivery provides <strong>elastic flexibility</strong> against traffic spikes at a near-zero marginal cost. It gives the site a <strong>robust foundation for SEO and Core Web Vitals</strong>, featuring clean, semantic markup that search engine crawlers and AI models can read with ease.',
      'tt.p3': 'Every structural change to the site is <strong>version-controlled</strong> and deployed automatically. Content and media files are stored in the cloud with <strong>full redundancy</strong>. Forms and site submissions are processed on <strong>Serverless infrastructure</strong>, utilizing invisible, challenge-based bot screening alongside <strong>preemptive AI analysis to prevent spam</strong>, well before any data is even accepted into the system. <strong>Zero maintenance, built-in backups, and modern protection at every layer.</strong>',
      'p1.title': 'Discovery',
